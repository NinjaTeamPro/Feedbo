...
export default {
    ...
    methods: {
        ...
        checkHeaderLight (){
            if (this.checkColor(this.category.theme.header ? this.category.theme.header : '#1890ff') == 'light')
            {return true;}
            else
            {return false;}
        ...
        checkHeaderDark (){
            if (this.checkColor(this.category.theme.header ? this.category.theme.header : '#1890ff') == 'dark')
            {return true;}
            else
            {return false;}
